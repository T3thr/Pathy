...
export default function SearchBar() {
    ...
    return (
        <div className="relative">
            ...
            <div className="flex justify-center w-full text-blue-700 dark:text-blue-100">
                <div onClick={toggleSearch} className="cursor-pointer p-2 rounded-full bg-indigo-200 dark:bg-indigo-700 hover:bg-indigo-300 transition-colors">
                    <FaSearch size={24} />
                </div>
            </div>
