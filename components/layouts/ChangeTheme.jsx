    ...
    return (
        <div className="fixed bottom-0 right-4 ">
            ...
            <button
                ...
                className={`z-50 w-20 h-6 flex items-center justify-center rounded-tl-lg rounded-tr-lg bg-gradient-to-r from-gray-700 to-gray-800 text-white shadow-lg hover:bg-gray-900 hover:scale-110 duration-300 fixed bottom-0 right-4 transition-all`}
            >
            ...
            >
                <button
                    ...
                    className={`w-16 h-16 items-center justify-center rounded-full shadow-xl transition-all duration-300 transform ${
                        theme === 'dark'
